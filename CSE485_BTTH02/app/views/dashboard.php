...
// Khởi tạo các biến để lấy số lượng
            ...
            <div class="col-sm-3">
                <div class="card mb-2" style="width: 100%;">
                    <div class="card-body">
                        ...
                        <h5 class="h1 text-center">110</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-3">
                <div class="card mb-2" style="width: 100%;">
                    <div class="card-body">
                        ...
                        <h5 class="h1 text-center"><?php echo $total_categories; ?></h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-3">
                <div class="card mb-2" style="width: 100%;">
                    <div class="card-body">
                        ...
                        <h5 class="h1 text-center"><?php echo $total_authors; ?></h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-3">
                <div class="card mb-2" style="width: 100%;">
                    <div class="card-body">
                        ...
                        <h5 class="h1 text-center"><?php echo $total_articles; ?></h5>
                    </div>
                </div>
            </div>
        </div>
