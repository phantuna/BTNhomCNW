        ...
        <div class="row">
            <div class="col-sm">
                ...
                <table class="table">
                    ...
                    <tbody>
                    <?php require_once '../services/DatabaseService.php';
                    ...
                    <?php
                        if (!empty($authors)) {
                            foreach ($authors as $author) {
                                ...
                                echo "<td><a href='./edit_author.php?id=" . $author['ma_tgia'] . "' class='fa-solid fa-pen-to-square'></a></td>";
                                echo "<td><a href='../controllers/AuthorController.php?action=delete&id=" . $author['ma_tgia'] . "' class='fa-solid fa-trash' onclick='return confirm(\"Bạn có chắc chắn muốn xóa tác giả này?\");'></a></td>";
                                echo "</tr>";
                            }
                        } else {
