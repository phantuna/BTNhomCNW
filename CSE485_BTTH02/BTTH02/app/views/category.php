                    ...
                    <?php
                        if (!empty($categories)) {
                            foreach ($categories as $category) {
                                ...
                                echo "<td><a href='./edit_category.php?id=" . $category['ma_tloai'] . "' class='fa-solid fa-pen-to-square'></a></td>";
                                echo "<td><a href='../controllers/CategoryController.php?action=delete&id=" . $category['ma_tloai'] . "' class='fa-solid fa-trash'></a></td>";
                                echo "</tr>";
                            }
                        } else {
